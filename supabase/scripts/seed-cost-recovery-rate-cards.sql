...
VALUES
  ...
  ('CAD_NGN_BANK', 'CAD', 'NGN', 'BANK', 'external', 'Bank', 'Nomba', 0.0055, 0.60, 0.005, 0.25, 0, 0.0015, 0.001, 0.75, 0.006, 0.005, 3.49, 3.49, 50, 'CAD', 'Highly competitive', 'Minutes – 1 hour', '2026-09-10', true),
  ('CAD_NGN_WALLET', 'CAD', 'NGN', 'WALLET', 'external', 'Wallet', 'Nomba', 0.006, 0.70, 0.005, 0.25, 0, 0.0015, 0.001, 0.75, 0.007, 0.005, 3.99, 3.99, 50, 'CAD', 'Competitive', 'Minutes', '2026-09-10', true),
  ...
  ('WALLET_CAD_NGN', 'CAD', 'NGN', 'WALLET_TO_WALLET', 'wallet', 'eFinMoney wallet', 'eFinMoney', 0, 0, 0, 0.05, 0, 0.001, 0.0008, 0.35, 0.006, 0.005, 1.50, 1.50, 25, 'CAD', 'Ecosystem', 'Instant', '2026-09-10', true),
...
VALUES
  ...
  ('consumer', 'payout', 'CAD', 'NGN',  NULL, 'fx_swap', 0.00, 0.50, 60, 1.50, 25, now()),
  ...
  ('consumer', 'payout', 'CAD', 'NGN',  'NG', 'bank', 0.00, 0.50, 60, 3.49, 50, now()),
  ('consumer', 'payout', 'CAD', 'NGN',  'NG', 'wallet', 0.00, 0.50, 70, 3.99, 50, now()),
