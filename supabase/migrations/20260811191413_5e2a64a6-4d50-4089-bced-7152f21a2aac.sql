CREATE TABLE public.partner_observed_costs (
...
CREATE INDEX idx_partner_observed_costs_partner ON public.partner_observed_costs (partner_id, observed_at DESC);
CREATE INDEX idx_partner_observed_costs_corridor ON public.partner_observed_costs (source_currency, dest_currency, payment_method);
CREATE UNIQUE INDEX idx_partner_observed_costs_ref ON public.partner_observed_costs (partner_id, provider_reference) WHERE provider_reference IS NOT NULL;
