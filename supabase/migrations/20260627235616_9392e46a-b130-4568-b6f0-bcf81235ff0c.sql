...
BEGIN
  -- Compute every (journal_id, currency_code) imbalance among affected journals
  -- and post all corrective FX Clearing legs in a SINGLE statement, so the
  -- recursive trigger invocation finds nothing left to do.
  WITH touched AS (
