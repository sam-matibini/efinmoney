...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // List orphans — admin-onboarded users who have not signed in within 14 days.
    // The view admin_orphaned_invitations does the filtering.
    ...
    return new Response(JSON.stringify({ orphans: orphans || [] }), {
      status: 200,
      headers: { ...corsHeaders, "Content-Type": "application/json" },
    });
  } catch (e) {
