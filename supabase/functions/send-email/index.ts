...
function passwordResetBody(d: Record<string, any>, appUrl: string) {
  ...
  return `
    ...
    <h1 style="margin:0 0 8px;font-family:'Space Grotesk','Inter',sans-serif;font-size:26px;font-weight:700;color:#0f172a;text-align:center;letter-spacing:-0.02em">Reset your password</h1>
    <p style="margin:0 0 22px;line-height:1.6;color:#334155;text-align:center">We received a request to reset your eFinMoney password. Click the button below to confirm it's you and choose a new one.</p>
    <div style="text-align:center;margin:0 0 18px">
      <a href="${actionLink}" style="display:inline-block;background:linear-gradient(135deg,#fdb913 0%,#f59e0b 100%);color:#0e0a26;text-decoration:none;padding:14px 32px;border-radius:9999px;font-weight:700;font-size:15px;box-shadow:0 10px 24px -8px rgba(245,158,11,0.55),inset_0_1px_0_0_rgba(255,255,255,0.4)">
        Reset password →
      </a>
    </div>
    ...
    <div style="margin:24px 0 0;padding:14px 16px;border-left:3px solid #fdb913;background:linear-gradient(135deg,#fffbeb 0%,#fef3c7 100%);border-radius:0 8px 8px 0">
      <p style="margin:0;color:#92400e;font-size:13px;line-height:1.5">
        <strong>This link expires in ${expires} minutes.</strong> If you didn't request a password reset, you can safely ignore this email — your password won't change.
      </p>
    </div>
  `;
}
