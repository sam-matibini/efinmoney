...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Complete a quick identity check (KYC) with Persona or by uploading documents for staff review. This keeps your money safe and is required before you can send.",
  },
  {
    icon: Wallet,
    title: "Add funds",
      ...
      <section className="bg-[hsl(var(--accent))]/30 py-20 md:py-24">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl bg-white border border-neutral-200/80 p-8">
            ...
            <p className="text-[15px] text-neutral-600 leading-relaxed">
              Onboard your organisation with a manual KYB document review (not Persona), fund your treasury, and run bulk payouts to suppliers and staff with
