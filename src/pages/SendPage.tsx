...
const SendPage = () => {
  ...
  const requestConfirm = () => {
    if (confirming || pinProcessing) return;
                            ...
                            {step === 1 && (
                              ...
                              >
                                ...
                                >
                                    ...
                                    <motion.div custom={0.5} variants={fieldVariants} initial="hidden" animate="show" className="space-y-2">
