  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className="mt-3">To exercise any of these rights, contact us at <a className="text-primary underline" href="mailto:privacy@efin.money">privacy@efin.money</a>.</p>
      </>
    ),
  },
  {
        ...
        <Card>
          <CardContent className="prose prose-invert max-w-none p-8 space-y-10 text-foreground/90 leading-relaxed">
            ...
            <div className="border-t border-border pt-6 flex items-center gap-2 text-sm text-muted-foreground">
              ...
              Questions? <a href="mailto:privacy@efin.money" className="text-primary underline">privacy@efin.money</a>
            </div>
          </CardContent>
        </Card>
      </section>
