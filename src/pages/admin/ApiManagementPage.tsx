...
const EDGE_FUNCTIONS: Array<{ name: string; description: string; jwt: boolean; category: string }> = [
  ...
  { name: "fincra-webhook",            description: "Fincra events + CAD Interac RFI auto-answer", jwt: false, category: "Fincra" },
  ...
  { name: "fincra-usd-bank",            description: "Fincra USD VA/ACH bank-receive intents", jwt: false, category: "Fincra" },
  { name: "fincra-usd-va-submit",       description: "List/request Fincra USD virtual account", jwt: false, category: "Fincra" },
  { name: "fincra-capability-probe",    description: "Dry wallets + CAD/USD quote probe (no payouts)", jwt: false, category: "Fincra" },
