...
export const CHECKOUT_STRINGS = {
  en: {
    ...
    plaid: "Interac",
    plaidDesc: "Use bank account to make instant payments",
    card: "Card",
  ...
  fr: {
    ...
    interac: "Interac",
    interacDesc: "Utilisez votre compte bancaire pour payer instantanément",
    plaid: "Interac",
    plaidDesc: "Utilisez votre compte bancaire pour payer instantanément",
    card: "Carte",
