...
const PARTNERS: PartnerMeta[] = [
  ...
  { id: "fincra", name: "Fincra", blurb: "Africa + western collect; CAD Interac Autodeposit; USD card + bank VA collect; CAD Interac/EFT + USD ACH/SWIFT payout (preferred), Nomba failover", collect: ["CAD", "USD", "EUR", "GBP", "NGN", "GHS", "KES", "UGX", "TZS", "ZMW", "ZAR", "XOF", "XAF", "MWK"], payout: ["NGN", "GHS", "KES", "UGX", "TZS", "ZMW", "ZAR", "XOF", "XAF", "CAD", "USD"] },
  { id: "nomba", name: "Nomba", blurb: "First-rank CAD collect (instant: card + Interac e-Transfer); CAD Interac/EFT + USD ACH payout failover; NGN bank + Global Payout", collect: ["NGN", "CAD"], payout: ["NGN", "GHS", "KES", "UGX", "TZS", "RWF", "XOF", "XAF", "ZAR", "CAD", "GBP", "EUR", "USD"] },
