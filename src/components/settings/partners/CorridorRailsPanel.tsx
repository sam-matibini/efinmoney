...
const PARTNERS: PartnerMeta[] = [
  ...
  { id: "fincra", name: "Fincra", blurb: "Primary payout rail (Africa MoMo/bank + CAD/USD); collect for CAD/USD/EUR/GBP/NGN", collect: ["CAD", "USD", "EUR", "GBP", "NGN", "GHS", "KES", "UGX", "TZS", "ZMW", "ZAR", "XOF", "XAF", "MWK"], payout: ["NGN", "GHS", "KES", "UGX", "TZS", "ZMW", "ZAR", "XOF", "XAF", "CAD", "USD"] },
  { id: "nomba", name: "Nomba", blurb: "Payout failover after Fincra; CAD collect (card + Interac)", collect: ["NGN", "CAD"], payout: ["NGN", "GHS", "KES", "UGX", "TZS", "RWF", "XOF", "XAF", "ZAR", "CAD", "GBP", "EUR", "USD"] },
  { id: "flutterwave", name: "Flutterwave", blurb: "Collect only (not used for payout — Fincra→Nomba)", collect: ["CAD", "USD", "NGN", "GHS", "KES", "UGX", "RWF", "TZS", "ZMW"], payout: [] },
