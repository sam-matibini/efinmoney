...
const PARTNERS: PartnerMeta[] = [
  ...
  { id: "fincra", name: "Fincra", blurb: "Africa collect + payout; CAD Interac Autodeposit collect; CAD Interac/EFT payout (preferred), Nomba failover", collect: ["CAD", "USD", "EUR", "GBP", "NGN", "GHS", "KES", "UGX", "TZS", "ZMW", "ZAR", "XOF", "XAF", "MWK"], payout: ["NGN", "GHS", "KES", "UGX", "TZS", "ZMW", "ZAR", "XOF", "XAF", "CAD"] },
  { id: "nomba", name: "Nomba", blurb: "First-rank CAD collect (instant: card + Interac e-Transfer); CAD Interac/EFT payout failover; NGN bank + Global Payout", collect: ["NGN", "CAD"], payout: ["NGN", "GHS", "KES", "UGX", "TZS", "RWF", "XOF", "XAF", "ZAR", "CAD", "GBP", "EUR", "USD"] },
