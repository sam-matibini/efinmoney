...
const PARTNERS: PartnerMeta[] = [
  ...
  { id: "fincra", name: "Fincra", blurb: "Africa collect + payout; CAD Interac Autodeposit collect (not CAD payout)", collect: ["CAD", "USD", "EUR", "GBP", "NGN", "GHS", "KES", "UGX", "TZS", "ZMW", "ZAR", "XOF", "XAF", "MWK"], payout: ["NGN", "GHS", "KES", "UGX", "TZS", "ZMW", "ZAR", "XOF", "XAF"] },
  { id: "nomba", name: "Nomba", blurb: "CAD card collect + CAD Interac/EFT payout; NGN bank + Global Payout (KE/GH/UG/TZ/RW/XOF/XAF/GBP/EUR/USD/ZAR…)", collect: ["NGN", "CAD"], payout: ["NGN", "GHS", "KES", "UGX", "TZS", "RWF", "XOF", "XAF", "ZAR", "CAD", "GBP", "EUR", "USD"] },
  ...
  { id: "interac", name: "Interac (legacy)", blurb: "Older Interac collect path — CAD Interac collect is Fincra Autodeposit", collect: ["CAD"], payout: [] },
];
